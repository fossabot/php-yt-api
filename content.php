...
<body class="fixed-sn  mdb-skin-custom" data-spy="scroll" data-target="#scrollspy" data-offset="15">
    ...
    <div class="card-body white-text rgba-black-light text-center">
      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-6 wow fadeIn">
          <h1 class="font-weight-bold mb-3 h2"><?= $title ?></h1>
          <h4 class="mb-2 h5">
            <?= $desc ?>
          </h4>
        </div>
  ...
  <!--RSS as Nav and Grid-->
  <script src='js/compiled.rss.min.js?hash=APL009'></script>
  <script src="https://cdn.jsdelivr.net/npm/sweetalert"></script>
  <script src="js/adsense.js?hash=APL009"></script>
  <script src="WMI/safelink/safelink.js?hash=APL009"></script>
  ...
  <script>
    $(document).ready(function() {
      ...
      <?php
      //include __DIR__ . '/views/rss.min.js';
      include __DIR__ . '/views/utility.min.js';
      if (isset($var['script']) && file_exists($var['script'])) {
        include $var['script'];
      }
      ?>
    });
